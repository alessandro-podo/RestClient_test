...
class Request
{
    ...
    public function setAuthBasic(?array $auth_basic): Request
    {
    ...
    public function addHeaders(string $fieldName, string $fieldValue): Request
    {
    ...
    public function addQuery(string $fieldName, string $fieldValue): Request
    {
    ...
    public function addJson(string $fieldName, string $fieldValue): Request
    {
